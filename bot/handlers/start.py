...
async def start_command_handler(
    ...
    await message.answer(
        ...
        f'нажмите на кнопу <b><em>"{button_text}"</em></b>, '
        'чтобы его отправить, или отправьте номер в формате +79393948839.\n\n'
        'На него будет приходить вызов во время приёма лекарств\n\n'
        f'Нажимая кнопку <b><em>"{button_text}"</em></b>, Вы соглашаетесь получать уведомления.',
